...
const TeacherCourseGroupDetailPage = () => {
    ...
    const fetchCourseGroupInfo = useCallback(async () => {
        try {
            const res = await api.get(`/teacher/courses/course-groups/${targetId}`);
            setCourseGroupInfo(res.data);
        } catch (err) {
            console.error("Error loading course group info", err);
            navigate("/not-found");
        }
    }, [targetId, navigate]);
    ...
    const fetchMaterials = useCallback(async () => {
        try {
            const res = await api.get(`/teacher/materials/course-groups/${targetId}/materials`);
    ...
    useEffect(() => {
        ...
        fetchMaterials();
    }, [fetchCourseGroupInfo, fetchMaterials]);
...
export default TeacherCourseGroupDetailPage;